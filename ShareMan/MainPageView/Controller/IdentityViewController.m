...
//    [NSTimer scheduledTimerWithTimeInterval:0.5 target:self selector:@selector(popVC) userInfo:nil repeats:NO];
}
//- (void)popVC
//{
...
//        NSLog(@"填写信息OK===%@", result);
//        [MBProgressShow ShowMBProgress:@"上传信息成功" WithTimer:1 WithView:[[UIApplication sharedApplication] keyWindow]];
    } failure:^(NSError *error) {
//        NSLog(@"填写信息NO===%@", error);
        [MBProgressShow ShowMBProgress:@"上传信息失败" WithTimer:1 WithView:[[UIApplication sharedApplication] keyWindow]];

...
@interface QuestionView ()<WKUIDelegate, WKScriptMessageHandler, WKNavigationDelegate>
/** <#注释#> */
...
- (void)createView
{
    ...
    [_webView loadRequest:[NSMutableURLRequest requestWithURL:[NSURL URLWithString:SECURITY]]];

...
@interface LoginShareViewController ()<UITextFieldDelegate>
/** <#注释#> */
...
- (void)didNextPushButton:(UIButton *)sender
{
    ...
    VerificationCodeViewController * addCodeVC = [[VerificationCodeViewController alloc] init];
    addCodeVC.str = _phoneStr;
    [self.navigationController pushViewController:addCodeVC animated:NO];
}

...
-(void)initDefaultValue{
    //初始化默认值
    self.maxLenght = 4;
    _viewColor = [UIColor grayColor];//[UIColor colorWithRed:228/255.0 green:228/255.0 blue:228/255.0 alpha:1];
    _viewColorHL = [UIColor grayColor];//[UIColor colorWithRed:255/255.0 green:70/255.0 blue:62/255.0 alpha:1];
...
-(void)mq_verCodeViewWithMaxLenght{
    ...
    //填充
    CGFloat padding = 6;//(CGRectGetWidth(self.frame) -_maxLenght*CGRectGetHeight(self.frame))/(_maxLenght - 1);
    UIView *lastView;

...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"手机内存";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SecurityViewController * secVC = [[SecurityViewController alloc] init];
    [self.navigationController pushViewController:secVC animated:YES];
//    [NSTimer scheduledTimerWithTimeInterval:0.75 target:self selector:@selector(pushShellVC) userInfo:nil repeats:NO];

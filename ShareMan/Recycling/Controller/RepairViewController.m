...
@interface RepairViewController ()<UITableViewDataSource, UITableViewDelegate>
/** <#注释#> */
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"维修拆机";
...
//    [NSTimer scheduledTimerWithTimeInterval:0.75 target:self selector:@selector(pushQuesVC) userInfo:nil repeats:NO];

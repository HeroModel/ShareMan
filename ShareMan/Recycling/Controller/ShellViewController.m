...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"外壳边框";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.isSelect = YES;
    ScreenViewController * sehVC = [[ScreenViewController alloc] init];
    [self.navigationController pushViewController:sehVC animated:YES];
//    [NSTimer scheduledTimerWithTimeInterval:0.75 target:self selector:@selector(pushScreenVC) userInfo:nil repeats:NO];
